    ...
    const docDefinition = {
        content: [
            ...
            { text: description, style: 'prescriptionText' },
            {
                ...
                table: {
                    body: [
                        // [{ text: 'Doctor\'s Signature', style: 'signature' }],
                        // [{ text: '________________________', style: 'signatureLine' }],
                        // [{ text: 'Doctor Information:', style: 'doctorInfo' }],
                        // [{ text: 'Mediwave Hospital', style: 'doctorInfo' }],
                        // [{ text: '15 Rankin Street, Wari, Dhaka 1203', style: 'doctorInfo' }],
                        // [{ text: 'Email: mediwave@hospital.bd', style: 'doctorInfo' }],
