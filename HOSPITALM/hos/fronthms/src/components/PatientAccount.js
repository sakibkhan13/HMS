...
function PatientAccount() {
    ...
    return (
        <div className="patient-account-background">
            <Navbar includeLogoutLink={true} handleLogout={handleLogout} includeImportantMessagesLink={true} />
            <div className="dashboard-container">
                <div className="welcome-profile-box">
                    <h1>Welcome, {patient.first_name} {patient.last_name}</h1>
                    <Link to="/patient-profile-update" className="profile-link">Update Your Profile</Link>
                </div>
